...
<link rel="icon" type="image/ico" href="<?= base_url('assets/frontend/np/images/fav.png');?>" />
<link href="<?= base_url('assets/frontend/np/images/fav.png');?>" rel="shortcut icon" type="image/x-icon" />
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/frontend/np/css/style.css');?>" />
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/frontend/np/slider/style_slider.css');?>" />
<script type="text/javascript" src="<?= base_url('assets/frontend/np/slider/js/jquery-1.8.2.js');?>" ></script>
<script type="text/javascript" src="<?= base_url('assets/frontend/np/slider/js/jquery-ui-1.9.0.custom.min.js');?>" ></script>
<script type="text/javascript" src="<?= base_url('assets/frontend/np/slider/js/jquery-ui-tabs-rotate.js');?>" ></script>
  ...
  <div id="content">
	<?php
		...
		<div class="post" style="margin-top: 15px;">
			<div class="thumb"><a href="<?= base_url('news/news_details/'.$news->news_id);?>">
				<img src="<?= base_url('assets/frontend/np/images/news/'.$news->news_image);?>" alt="" /></a>
			</div>
			<div style="height: 80px;"><h3><a href="<?= base_url('news/news_details/'.$news->news_id);?>"><?php echo $news->news_headline;?></a></h3></div>
			...
			<a class="continue" href="<?= base_url('news/news_details/'.$news->news_id);?>">বিস্তারিত..</a>
		</div>
		<!-- end post -->
	<?php } ?>
