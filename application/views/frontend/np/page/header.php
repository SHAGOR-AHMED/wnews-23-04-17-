...
<div id="header">
	...
	<div>
		<div style="height:40px; width:1200px; background:#000; float:left; clear:right; color:#000000; font-size:18px;">
		   ...
		   ?>
			...
			<!-- <div style="height:30px; width:100px; float:left; position:relative; top:4px; ">
				<a href="fonts/SolaimanLipi_04_07_05.ttf" download><img src="<?= base_url('asstes/frontend/np/images/bangla_font.png');?>" /></a>
			</div> -->
		...
		<div style="height:120px; width:1200px; background:#ffffff; float:left; clear:right;">
			<div>
				<a href="index.php"><img width="370px" height="120px" style=" position:relative; left:4px; float:left; clear:right;" src="<?= base_url('assets/frontend/np/images/banner/2.png');?>" alt="" /></a>
			</div>
			...
			?>
				<div style=" width:820px; height:119px; position:relative; right:4px; float:right;">
					<a href="<?php //echo $adsShow1[2];?>" target="blank"> <img src="<?= base_url('assets/frontend/np/adsimage/'.$query1->img_name);?>?>" alt=""
		...
		<table style="height:33px; width:1200px; background:#ffffff; float:left; clear:right;">
		  <tr>
			<td></td>
			<td><img src="<?= base_url('assets/frontend/np/images/skhabor.png');?>" height="30px" align="right" /></td>
			<td>&nbsp;</td>
			...
			?>
			  <img src="<?= base_url('assets/frontend/np/images/fav.png');?>" alt="" width="15px" height="15px" style="position:relative; top:2px;"/>&nbsp;<font color="#000000"><?php echo $qr->top_news;?></font>
			  <?php } ?>
			  </marquee>
			</td>
			<td>&nbsp;</td>
