...
<ul class="ui-tabs-nav">
	...
	?>
		<li class="ui-tabs-nav-item" id="nav-fragment-<?php echo $total;?>">
			<img src="<?= base_url('assets/frontend/np/images/news/'.$qr->news_image);?>" alt="" style="width:100px; height:60px;" />
            <span style="font-size: 10px !important;">
                <?php echo $qr->news_headline;?></span>
		</li>
	...
	?>
		...
		<div id="fragment-<?php echo $total;?>" class="ui-tabs-panel">
			<a href="<?php echo  base_url('news/news_details/'.$qr3->news_id)?>" >
                <img src="<?= base_url('assets/frontend/np/images/news/'.$qr3->news_image);?>" height="300px" width="556px" style="position: unset;" />
			</a>
			
			 <div class="info" >
				<h2><a href="<?php echo  base_url('news/news_details/'.$qr3->news_id)?>" ><?php echo $qr->news_headline;?></a></h2>
