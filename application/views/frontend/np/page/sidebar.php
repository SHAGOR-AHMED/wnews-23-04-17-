...
<table width="280">
  <tr>
    <td width="139" height="38"><img src="<?= base_url('assets/frontend/np/images/vote.jpg'); ?>" width="326px" /></td>
    </tr>
  <tr>
...
<tr>
  ...
  <tr>
    ...
    <img src="<?= base_url('assets/frontend/np/images/weather.jpg');?>" width="328px" /></td>
    </tr>
  <tr>
    ...
    <?php
      ...
      <div class="video"> 
        <div style="float:left; min-height:200px; width:320px; margin-right:8px;">
          <a href="video_gallery.php"><div style="padding:4px 0;"><img src="<?= base_url('assets/frontend/np/images/video.jpg');?>" width="328px" /></div></a>
...
<h1 style="background-color: #063; margin-top:380px;"><img src="<?= base_url('assets/frontend/np/images/archive.jpg');?>" width="278px" /></h1>
...
?>
  <div style=" width:326px; height:200px; position:relative; float:right; border:1px solid black; ">
      ...
      <img src="<?= base_url('assets/frontend/np/adsimage/'.$adsimage->img_name);?>" alt=""
