...
?>
    ...
    <div class="thumb"><img src="<?= base_url('assets/frontend/np/images/news/'.$JatioImage->news_id.'.jpg');?>" alt="" /></a></div>
...
<?php
  ...
  foreach($Jationews as $jatio){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$jatio->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$RajnitiImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($Rajnitinews as $rajniti){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$rajniti->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$BideshImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($BideshNews as $bidesh){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$bidesh->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$KhalaImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($KhelaNews as $khela){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$khela->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$ChitaImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($ChitaNews as $cheta){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$cheta->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$BinodonImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($BinodonHeadLine as $binodon){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$binodon->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$ShikkhaImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($ShikkhaHeadLine as $shikkha){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$shikkha->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$BigganImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($BigganHeadLine as $biggan){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$biggan->news_id);?>">
...
?>
  <div class="post" style="margin-top: -10px;">
    ...
    <div class="thumb">
    <img src="<?= base_url('assets/frontend/np/images/news/'.$SastoImage->news_id.'.jpg');?>" alt="" /></a> </div>
...
<?php
  ...
  foreach($SastoHeadLine as $sasto){ ?>
    ...
    <div style="border-bottom: 1px solid #008282; ">
      <a href="<?= base_url('news/news_details/'.$sasto->news_id);?>">
