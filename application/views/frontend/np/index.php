...
<!-- Add 2 Start -->
	...
	<a href="<?php echo $query1->site_link;?>" target="blank">
        <img src="<?= base_url('assets/frontend/np/adsimage/'.$query1->img_name);?>" alt=""
...
<!-- Add 2 End --> 
	...
	<img src="<?= base_url('assets/frontend/np/adsimage/'.$query1->img_name);?>" alt="" style=" width:818px; height:119px; position:relative; float:left;" />
	</div>
